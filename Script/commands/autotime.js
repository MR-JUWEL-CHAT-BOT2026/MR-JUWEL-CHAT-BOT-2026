...
module.exports.onLoad = ({ api }) => {
  ...
  global.autotimeInterval = setInterval(async () => {
    try {
      ...
      if (hour === 7 && minute === 40 && !sentReminders.has("goodMorning")) {
        sentReminders.add("goodMorning");
      ...
      // ========== সকালের আমল (ভোর ৫:২০) ==========
      if (hour === 5 && minute === 20 && !sentReminders.has("morningAmol")) {
        sentReminders.add("morningAmol");
      ...
      if (hour === 16 && minute === 30 && !sentReminders.has("dailyDua")) {
        sentReminders.add("dailyDua");
      ...
      if (hour === 5 && minute === 10 && !sentReminders.has("morningContent")) {
        sentReminders.add("morningContent");
      ...
      if (hour === 22 && minute === 30 && !sentReminders.has("goodNight")) {
        sentReminders.add("goodNight");
      ...
      if (hour === 18 && minute === 0 && !sentReminders.has("eveningAmol")) {
        sentReminders.add("eveningAmol");
      ...
      for (const [name, time] of Object.entries(prayerTimes)) {
        ...
        if (diff === 10 && !sentReminders.has(name + global.currentDivision)) {
          sentReminders.add(name + global.currentDivision);
